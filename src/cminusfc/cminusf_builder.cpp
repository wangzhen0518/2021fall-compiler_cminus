...
void CminusfBuilder::visit(ASTSelectionStmt& node) {
    ...
    if(node.expression != nullptr){
        ...
        if(node.else_statement!=nullptr){
            auto truebb=BasicBlock::create(module.get(),"true",main_fun);
            auto falsebb=BasicBlock::create(module.get(),"false",main_fun);
            auto retbb=BasicBlock::create(module.get(),"ret",main_fun);
...
void CminusfBuilder::visit(ASTIterationStmt& node) {
    ...
    if(node.expression!=nullptr&&node.statement!=nullptr){
        node.expression->accept(*this);
        auto cmpbb=BasicBlock::create(module.get(),"cmp",main_fun);
        auto circlebb=BasicBlock::create(module.get(),"circle",main_fun);
        auto retbb=BasicBlock::create(module.get(),"ret",main_fun);
        //cmp
